...
//  string OutputFileName;
 ...
 Int_t event_id;
  ...
  std::vector<double>* mc_kin_ttllEFT_only_inputvars;
  ...
  std::vector<double>* mc_kinInt_ttllEFT_only_inputvars;
  ...
  Double_t mc_mem_ttllEFT_only_weight;
  Double_t mc_mem_ttllEFT_only_weight_JEC_up, mc_mem_ttllEFT_only_weight_JEC_down, mc_mem_ttllEFT_only_weight_JER_up, mc_mem_ttllEFT_only_weight_JER_down;
  Double_t mc_mem_ttllEFT_only_weight_log;
  Double_t mc_mem_ttllEFT_only_weight_err;
  Float_t mc_mem_ttllEFT_only_weight_chi2;
  Float_t mc_mem_ttllEFT_only_weight_time;
  Double_t mc_mem_ttllEFT_only_weight_max;
  Double_t mc_mem_ttllEFT_only_weight_avg;
  Double_t mc_mem_ttllEFT_only_weight_logmean;
  Double_t mc_kin_ttllEFT_only_weight_logmax;
  Double_t mc_kin_ttllEFT_only_weight_logmaxint;
  Double_t mc_mem_ttllEFT_only_weight_kinmax;
  Double_t mc_mem_ttllEFT_only_weight_kinmaxint;

  TLorentzVector mc_kin_ttllEFT_only_tophad_P4;
  TLorentzVector mc_kin_ttllEFT_only_tophad_Bjet_P4;
  TLorentzVector mc_kin_ttllEFT_only_tophad_W_P4;
  TLorentzVector mc_kin_ttllEFT_only_tophad_Jet1_P4;
  TLorentzVector mc_kin_ttllEFT_only_tophad_Jet2_P4;
  Float_t mc_kin_ttllEFT_only_tophad_Pt;
  Float_t mc_kin_ttllEFT_only_tophad_Wmass;
  Float_t mc_kin_ttllEFT_only_tophad_Benergy;
  Float_t mc_kin_ttllEFT_only_tophad_Jet1energy;
  Float_t mc_kin_ttllEFT_only_tophad_Jet2energy;
  TLorentzVector mc_kin_ttllEFT_only_toplep_P4;
  TLorentzVector mc_kin_ttllEFT_only_toplep_Bjet_P4;
  TLorentzVector mc_kin_ttllEFT_only_toplep_W_P4;
  TLorentzVector mc_kin_ttllEFT_only_toplep_Lep_P4;
  TLorentzVector mc_kin_ttllEFT_only_toplep_Neut_P4;
  Float_t mc_kin_ttllEFT_only_toplep_Pt;
  Float_t mc_kin_ttllEFT_only_toplep_Wmass;
  Float_t mc_kin_ttllEFT_only_toplep_Benergy;
  Float_t mc_kin_ttllEFT_only_toplep_Neutenergy;
  TLorentzVector mc_kin_ttllEFT_only_toplep2_P4;
  TLorentzVector mc_kin_ttllEFT_only_toplep2_Bjet_P4;
  TLorentzVector mc_kin_ttllEFT_only_toplep2_W_P4;
  TLorentzVector mc_kin_ttllEFT_only_toplep2_Lep_P4;
  TLorentzVector mc_kin_ttllEFT_only_toplep2_Neut_P4;
  Float_t mc_kin_ttllEFT_only_toplep2_Pt;
  Float_t mc_kin_ttllEFT_only_toplep2_Wmass;
  Float_t mc_kin_ttllEFT_only_toplep2_Benergy;
  Float_t mc_kin_ttllEFT_only_toplep2_Neutenergy;
  TLorentzVector mc_kin_ttllEFT_only_zll_P4;
  TLorentzVector mc_kin_ttllEFT_only_zll_Lep1_P4;
  TLorentzVector mc_kin_ttllEFT_only_zll_Lep2_P4;
  Float_t mc_kin_ttllEFT_only_zll_Pt;
  Float_t mc_kin_ttllEFT_only_zll_Zmass;
  ...
  Double_t mc_mem_ttz_ttllEFT_only_likelihood;
  Double_t mc_mem_ttz_ttllEFT_only_likelihood_nlog;
  Double_t mc_mem_ttz_ttllEFT_only_likelihood_max;
  Double_t mc_mem_ttz_ttllEFT_only_likelihood_avg;
